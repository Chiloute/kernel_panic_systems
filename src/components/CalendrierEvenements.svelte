...
<div class="flex flex-col lg:flex-row gap-6">
        ...
        {:else}
          ...
          <button
            ...
            class="relative flex flex-col items-center justify-center aspect-square rounded-lg text-sm font-mono
              ...
              : hasEv
                ? 'text-zinc-100 hover:bg-zinc-800 cursor-pointer'
  ...
  <div class="lg:w-80 flex flex-col">
    {#if selected}
      <div
        class="bg-zinc-900 border border-zinc-700 rounded-xl p-6 flex flex-col gap-4 h-full"
      >
        <!-- Badge passé / à venir -->
        <span
          class="self-start text-xs font-mono px-2.5 py-1 rounded border
        ...
        <div>
          <p class="font-mono text-xs text-zinc-500 mb-2 capitalize">
            {fmtDate(selected.date)}
          </p>
          <h3 class="font-bold text-zinc-100 text-xl leading-snug">
            {selected.titre}
          </h3>
        </div>
        ...
        <p class="text-sm text-zinc-400 leading-relaxed line-clamp-4">
    ...
    {:else}
      <div
        class="bg-zinc-900/40 border border-zinc-800 border-dashed rounded-xl p-6 flex flex-col items-center justify-center gap-3 h-full min-h-48 text-center"
      >
        <svg
