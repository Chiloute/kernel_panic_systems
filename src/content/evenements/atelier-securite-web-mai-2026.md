...
description: Atelier pratique sur les vulnérabilités web — OWASP Top 10, démonstrations live d'injections SQL, XSS et CSRF sur environnement de lab.
date: 2026-05-14
lieu: Salle TP Réseau — IUT
---
...
- Aucun prérequis strict — débutants bienvenus
- Un laptop avec un navigateur web et Burp Suite Community (gratuit)
- Curiosité et envie d'apprendre

## Intervenant

Animé par les membres du pôle Cyber de KPS.
